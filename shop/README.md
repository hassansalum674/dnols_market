...
| SKU add/edit / notes | Saved locally, then `POST /listings` onto the shop pin from onboarding. |
...
| Place | Stall GPS pin from onboarding (`POST /shops`), shown on Shop settings. `GET /places` for Kariakoo cluster. |
