...
const EN = {
  ...
  myRiders: "My riders",
  myRidersHint: "You own these riders. Assign them to delivery orders from Orders.",
  addRider: "Add rider",
  riderName: "Name (optional)",
  riderNamePh: "e.g. Juma",
  riderPhone: "Phone number *",
  riderAdding: "Adding…",
  riderSaved: "Rider saved. Ask them to open rider.dnols.com.",
  ...
  assignRiderHint: "Choose an idle rider for this delivery.",
  assignedTo: "Rider",
  noIdleRiders: "No idle riders. Add one under My riders.",
  myShop: "My shop",
...
const SW: typeof EN = {
  ...
  myRiders: "Rider wangu",
  myRidersHint: "Wewe ndiye mmiliki. Wape oda za delivery kutoka Orders.",
  addRider: "Ongeza rider",
  riderName: "Jina (si lazima)",
  riderNamePh: "mf. Juma",
  riderPhone: "Namba ya simu *",
  riderAdding: "Inaongeza…",
  riderSaved: "Rider amehifadhiwa. Waambie afungue rider.dnols.com.",
  ...
  riderIdle: "Hana kazi",
  riderBusy: "Ana kazi",
  assignRider: "Mpe rider",
  assignRiderHint: "Chagua rider aliye idle kwa delivery hii.",
  assignedTo: "Rider",
  noIdleRiders: "Hakuna rider idle. Ongeza kwenye My riders.",
  myShop: "Duka langu",
