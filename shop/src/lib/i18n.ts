...
const EN = {
  ...
  descAssistHint:
    "Type a few words. The AI reads them and asks a follow-up about this item — not a fixed form — then writes the listing.",
...
const SW: typeof EN = {
  ...
  descAssistHint:
    "Andika maneno machache. AI inasoma na kuuliza swali kuhusu bidhaa hii — si fomu ya kudumu — kisha inaandika maelezo.",
