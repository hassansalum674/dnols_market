...
The **rider** app (**rider.dnols.com**) signs in with **Google** only. After sign-in, the rider enters the phone number the seller saved under **My Riders** so deliveries can be matched.
